...
'you','your']
    ...
    with open("answers.txt", "a") as f:
        f.write('\n')
        f.write('\n --the dictionary term from index 1 with the highest df: ' +str(b))
        f.write('\n')
        f.write('\n the dictionary term from index 1 with the lowest df:\n ')
        for i in low:
            f.write(str(i)+'\n')
...
fh=open("Index_version1_uncompressed1.txt",'w')
start= time.time()
print(ver(),file = fh)
end= time.time()
